...
const updates = {
  ...
  "M06-D02": {
    ...
    change: [
      ...
      "Suno v5.5는 Voices·Custom Models·My Taste 기능을 추가",
      "CapCut 자동 자막은 Web·Desktop·Mobile에서 가능하나 세부 기능은 다름",
    ],
...
`,
      ...
      sessions: [
        ...
        "CapCut 또는 타임라인 보드에서 음량·자막·전환을 최종 점검합니다.",
      ],
      prompts: [
...
`,
      ...
      sessions: [
        ...
        "CapCut 또는 타임라인 보드에서 제품 일치·자막 안전 영역·음량을 점검합니다.",
      ],
      prompts: [
